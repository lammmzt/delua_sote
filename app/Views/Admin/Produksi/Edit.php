                ...
                <div class="card-body">
                    <div class="card-title">
                        <div class="d-flex justify-content-between">
                            <h4>Form Edit Permintaan Produksi</h4>

                        </div>
                    </div>
                    <!-- <form class="form-sample" action="<?= base_url('Produksi/ubahProduksi'); ?>" method="POST"> -->
                    <?= csrf_field(); ?>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control w-100 js-example-basic-single" name="id_supplier"
                                    ...
                                    <option value="<?= $value['id_supplier']; ?>"
                                        <?= ($value['id_supplier'] == $produksi['id_supplier']) ? 'selected' : ''; ?>>
                                        <?= $value['nama_supplier']; ?>
                                    </option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea type="date" class="form-control" id="ket_produksi" name="ket_produksi"
                                    required
                                    placeholder="Keterangan"><?= (old('ket_produksi')) ? old('ket_produksi') : $produksi['ket_produksi']; ?></textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control w-100 js-example-basic-single" name="id_bahan" id="id_bahan"
                                    ...
                                    <option value="<?= $value['id_bahan']; ?>"
                                        <?= ($value['id_bahan'] == $proses_produksi['id_bahan']) ? 'selected' : ''; ?>>
                                        <?= $value['nama_bahan']; ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="panjang" name="panjang" required
                                    placeholder="panjang"
                                    value="<?= (old('panjang')) ? old('panjang') : $proses_produksi['panjang']; ?>">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="harga_bahan" name="harga_bahan" required
                                    ...
                                    value="<?= (old('harga_bahan')) ? old('harga_bahan') : $proses_produksi['harga_bahan']; ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
...
var get_all_jenis_produk = <?= json_encode($detail_produksi); ?>;
$.each(get_all_jenis_produk, function(key, value) {
    data_jenis_produk.push({
        id_jenis_produk: value.id_jenis_produk,
        nama_jenis_produk: value.nama_produk + ' (' + value.nama_jenis_produk + ')',
        jumlah_produk: value.jumlah_permintaan_produksi
    });
});
...
function addData() {
    ...
    if (index == -1) { // jika data tidak ditemukan
        data_jenis_produk.push({
        ...
        data_jenis_produk[index].jumlah_produk++; // jika data ditemukan
    }
...
// jika tombol add jenis produk di klik
