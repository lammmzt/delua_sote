...
class jenisProdukModel extends Model
{
    ...
    public function getJenisProduk($id = false)
    {
        if($id === false){
            return $this
            ->select('jenis_produk.id_jenis_produk, produk.nama_produk, jenis_produk.nama_jenis_produk, jenis_produk.deskripsi, jenis_produk.harga_jadi, jenis_produk.harga_jual, jenis_produk.stok_produk, jenis_produk.id_produk, produk.id_produk')
